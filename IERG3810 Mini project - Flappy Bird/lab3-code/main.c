...
void experiment_3_1(){
		...
		u16 color[5] = {0x0000,0xFFFF,0x07E0,0xF800,0x001F};
		for(y=0x000A; y <=0x0032; y+=0x000A){ //x=10, y=10,20,30,40,50
			for(x=0x000A;x<0x0014;x++)
			{
				 int temp = y/0x000A - 0x0001; //temp = 0 1 2 3 4
				 IERG3810_TFTLCD_DrawDot(x,y,color[temp]);
			}
		}
}
...
void experiment_3_4(){
			u8 str1[10] = {0x0031,0x0031,0x0035,0x0035,0x0030,0x0037,0x0036,0x0037,0x0032,0x0037};
			u8 str2[10] = {0x0031,0x0031,0x0035,0x0035,0x0030,0x0037,0x0036,0x0037,0x0033,0x0030};
			IERG3810_TFTLCD_FillRectangle(0x07E0,0x0000,0x00F0,0,0x0140);
			IERG3810_TFTLCD_ShowCharInLine(0x0050,0x0050,str1,0x000A,0x0000, 0x07E0);
			IERG3810_TFTLCD_ShowCharInLine(0x0050,0x0060,str2,0x000A,0x0000, 0x07E0);
		  Delay(4000000);
			/*IERG3810_TFTLCD_ShowChar(0x0050,0x0050,0x31, 0x0000, 0x07E0);
		  IERG3810_TFTLCD_ShowChar(0x0058,0x0050,0x31, 0x0000, 0x07E0);
		IERG3810_TFTLCD_ShowChar(0x0058,0x0050,0x31, 0x0000, 0x07E0);
		IERG3810_TFTLCD_ShowChar(0x0058,0x0050,0x31, 0x0000, 0x07E0);*/
}
...
void experiment_3_5(){
	u8 str1[10] = {0x0031,0x0031,0x0035,0x0035,0x0030,0x0037,0x0036,0x0037,0x0032,0x0037};
			u8 str2[10] = {0x0031,0x0031,0x0035,0x0035,0x0030,0x0037,0x0036,0x0037,0x0033,0x0030};
			IERG3810_TFTLCD_FillRectangle(0xF800,0x0000,0x00F0,0,0x0140);
			IERG3810_TFTLCD_ShowCharInLine(0x0050,0x0050,str1,0x000A,0x0000, 0xF800);
			IERG3810_TFTLCD_ShowCharInLine(0x0050,0x0060,str2,0x000A,0x0000, 0xF800);  
			IERG3810_TFTLCD_ShowChinChar(0x40,0x50,0x00,0x0000, 0xF800);
			IERG3810_TFTLCD_ShowChinChar(0x40,0x60,0x01,0x0000, 0xF800);
		Delay(4000000);
}
int main(void){
